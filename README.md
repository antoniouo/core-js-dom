...
`Release 0` содержит в себе теоретическую часть и работу в консоли. Идея в том, чтобы ты внимательно вчитался и усвоил все что написано ниже, а также попробовал поработать в консоли и посмотрел как меняется твоя страничка. 
